...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True,
        test_out_dir='results_vehicles/test_backdoor',
        type='GroundingVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
launcher = 'none'
load_from = 'work_dirs/grounding_dino_swin-t_prompt_tune_vehicles_backdoor/epoch_20.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '../DATASET/odinw/VehiclesOpenImages/valid/annotations_without_background.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
work_dir = 'results_vehicles/test_backdoor'
