...
Source: https://github.com/KMnP/vpt/blob/main/src/models/vit_backbones/swin_transformer.py
"""
import torch
...
class SwinTransformerBase(nn.Module):
    ...
    def __init__(self, pretrain_img_size=224, patch_size=4, in_channels=3, num_classes=1000,
        ...
        self.patch_embed = PatchEmbed(
            img_size=pretrain_img_size, patch_size=patch_size, in_chans=in_channels, embed_dim=embed_dims,
        ...
        for i in out_indices:
            self.norm = norm_layer(self.num_features[i])
            layer_name = f'norm{i}'
